...
if n_shards is not None and shard_id is not None:
    ...
    if dbname != "SIFT1000M":
        ...
        tmpdir = '/mnt/nfs-vlsi/juchanlee/Faiss_experiments/dataset/bench_cpu_{}_{}_{}shards'.format(dbname, index_key, n_shards)
else:
    ...
    if dbname != "SIFT1000M":
        ...
        tmpdir = '/mnt/nfs-vlsi/juchanlee/Faiss_experiments/dataset/bench_cpu_{}_{}'.format(dbname, index_key)
...
if dbname.startswith('SIFT'):
    if dbname != "SIFT1000M":
        ...
        # SIFT1000M is in NAS
        dbsize = int(dbname[4:-1])
        xb = mmap_bvecs('/mnt/nfs-vlsi/juchanlee/Faiss_experiments/bigann/bigann_base.bvecs')
        xq = mmap_bvecs('/mnt/nfs-vlsi/juchanlee/Faiss_experiments/bigann/bigann_query.bvecs')
        xt = mmap_bvecs('/mnt/nfs-vlsi/juchanlee/Faiss_experiments/bigann/bigann_learn.bvecs')
