...
int main(int argc, char** argv)
{
    ...
    if (strncmp(db_name.c_str(), "SIFT", 4) == 0) {
        if (db_name == "SIFT100M") {
            data_dir_prefix = "/mnt/scratch/wenqi/Faiss_Enzian_U250_index/SIFT100M_IVF32768,PQ16";
            raw_gt_vec_ID_suffix_dir = "idx_100M.ivecs";
            raw_gt_dist_suffix_dir = "dis_100M.fvecs";
        }
        else if (db_name == "SIFT1000M") {
            data_dir_prefix = "/mnt/scratch/wenqi/Faiss_Enzian_U250_index/SIFT1000M_IVF32768,PQ16";
        ...
        product_quantizer_dir_suffix = "product_quantizer_float32_16_256_8_raw";
