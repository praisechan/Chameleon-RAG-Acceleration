...
from transformers import pipeline, AutoModelForCausalLM, AutoConfig, AutoTokenizer, BitsAndBytesConfig
from ragatouille import RAGPretrainedModel
import torch.cuda.nvtx as nvtx

# Initialize embedding model and vector store
EMBEDDING_MODEL_NAME = "thenlper/gte-small"
config_kwargs ={"max_position_embeddings": 1024}
# config = AutoConfig.from_pretrained(EMBEDDING_MODEL_NAME, **config_kwargs)

import os
os.environ["IGNORE_MISMATCHED_SIZES"]="1"
embedding_model = HuggingFaceEmbeddings(
    model_name=EMBEDDING_MODEL_NAME,
    multi_process=False,
    # model_kwargs={"device": "cuda"},
    model_kwargs={"device": "cuda", "config_kwargs": config_kwargs},
...
def answer_with_rag(question: str, num_retrieved_docs: int = 100, num_docs_final: int = 5):
    # Retrieve documents
    ...
    if RERANKER:
        relevant_docs = RERANKER.rerank(question, relevant_docs, k=num_docs_final, bsize=32)
